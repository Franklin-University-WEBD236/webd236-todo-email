<html>
  <body>
    <p>A request was received by <?php echo(getenv('PROJECT_DOMAIN')); ?> to reset the password associated with this address.</p>
    ...
    <p>For your protection, this URL will expire 60 minutes after it is generated. Please do
      ...
      <a href="mailto:support@<?php echo(getenv('PROJECT_DOMAIN').'.glitch.me'); ?>">support@<?php echo(getenv('PROJECT_DOMAIN').'.glitch.me'); ?></a>.</p>
  </body>
</html>